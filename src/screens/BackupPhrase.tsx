...
export function BackupPhrase(){const navigation=useNavigation<any>(); const {wallet}=useApp(); const phrase: string=(wallet as any)?.mnemonic||''; const words=phrase.split(' '); const [confirmed,setConfirmed]=React.useState(false);
