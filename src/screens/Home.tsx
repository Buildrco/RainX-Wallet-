...
export function Home({navigation}:any){
 ...
 const quickActions: Array<[string, string, 'danger' | 'success']> = [['arrow-up','Send','danger'],['arrow-down','Receive','success']];
